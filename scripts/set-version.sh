...
update_app_version_in_helm_charts ".github/helm/HiveSpace/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/HiveSpace/charts/graphql/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/HiveSpace/charts/sync/Chart.yaml" "$new_version"
